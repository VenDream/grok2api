...
func TestUnpricedVoiceRemainsAvailableToFiniteClientKey(t *testing.T) {
	...
	executed := false
	result, err := service.executeVoice(ctx, "req-voice-billing", clientkey.Key{ID: 1, BillingLimitUSDTicks: 1}, voiceModel, audit.OperationTTS, modeldomain.CapabilityTTS, true, true, audit.PricingResult{}, func(account.Provider) bool {
		return true
...
func TestVoicePricingSettlesTTSAndRESTSTTUsage(t *testing.T) {
	...
	ttsResult, err := service.executeVoice(ctx, "req-priced-tts", limitedKey, ttsModel, audit.OperationTTS, modeldomain.CapabilityTTS, true, true, ttsPricing, func(account.Provider) bool {
		return true
	}, func(context.Context, account.Provider, account.Credential, string) (voiceExecutionResult, error) {
	...
	sttResult, err := service.executeVoice(ctx, "req-priced-stt", limitedKey, sttModel, audit.OperationSTT, modeldomain.CapabilitySTT, true, true, audit.PricingResult{}, func(account.Provider) bool {
		return true
	}, func(context.Context, account.Provider, account.Credential, string) (voiceExecutionResult, error) {
	...
	executed := false
	_, err = service.executeVoice(ctx, "req-capped-tts", cappedKey, ttsModel, audit.OperationTTS, modeldomain.CapabilityTTS, true, true, ttsPricing, func(account.Provider) bool {
		return true
	}, func(context.Context, account.Provider, account.Credential, string) (voiceExecutionResult, error) {
		executed = true
		return voiceExecutionResult{response: jsonVoiceResponse(http.StatusOK, map[string]any{"ok": true}), pricing: ttsPricing}, nil
