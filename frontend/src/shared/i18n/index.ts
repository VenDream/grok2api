  ...
  "zh-CN": {
    translation: {
      ...
      creativeConsole: {
        ...
        xSearchOn: "开启 X 搜索",
        xSearchOff: "关闭 X 搜索",
        xSearchUnavailableWeb: "Grok Web 不支持 X 搜索",
        reasoningEffort: "推理模式",
        reasoningEffortFixed: "该模型推理强度固定，不可调节",
        reasoningEffortUnsupported: "该模型不支持调节推理强度",
        ...
        imageEditPlaceholder: "描述希望对参考图做的修改、风格和细节。",
        ...
        referenceImageCount: "参考图 {{count}}",
        referenceModeLocal: "本地上传",
        referenceModeRemote: "远程 URL",
        uploadReferenceImages: "上传参考图片",
        addReferenceImage: "添加参考图片",
        addReferenceURL: "添加 URL",
        replaceReferenceImage: "替换参考图片",
        removeReferenceImage: "移除参考图片",
        referenceImageURL: "参考图片 URL {{index}}",
        localReferenceHint: "支持 JPEG / PNG / WebP / GIF，最多 8 张，单张不超过 12 MiB。有参考图时走图片编辑。",
        remoteReferenceHint: "支持填写多个 HTTPS 图片 URL；有参考图时走图片编辑。",
        videoLocalReferenceHint: "支持 JPEG / PNG / WebP / GIF，最多 1 张首图，单张不超过 12 MiB。",
        videoRemoteReferenceHint: "填写 1 个 HTTPS 图片 URL 作为视频首图。",
        videoReferenceLocalHint: "支持 JPEG / PNG / WebP / GIF，最多 1 张参考图，单张不超过 12 MiB。",
        videoReferenceRemoteHint: "填写 1 个 HTTPS 图片 URL 作为视频参考图。",
        referencePreviewFailed: "无法预览该图片 URL（可能无法访问或跨域限制）",
        openReferencePreview: "全屏预览参考图片",
        ...
        errors: {
          ...
          noAudio: "请先选择音频文件",
          imageReferenceLimit: "参考图片最多 {{count}} 张",
          imageReferenceType: "仅支持 JPEG、PNG、WebP 或 GIF 图片",
          imageReferenceTooLarge: "单张参考图片不能超过 12 MiB",
          imageReferenceReadFailed: "读取本地参考图片失败，请重试",
        },
      },
      media: {
        images: {
  ...
  en: {
    translation: {
      ...
      creativeConsole: {
        ...
        xSearchUnavailableWeb: "Grok Web does not support X search",
        reasoningEffort: "Reasoning mode",
        reasoningEffortFixed: "This model uses fixed reasoning and cannot be adjusted",
        reasoningEffortUnsupported: "This model does not support adjustable reasoning effort",
        ...
        imageEditPlaceholder: "Describe the changes, style, and details to apply to the reference image.",
        ...
        referenceImageShort: "Reference images",
        referenceImageAdded: "Image added",
        referenceImageCount: "{{count}} refs",
        referenceModeLocal: "Local upload",
        referenceModeRemote: "Remote URL",
        uploadReferenceImages: "Upload reference images",
        addReferenceImage: "Add reference image",
        addReferenceURL: "Add URL",
        replaceReferenceImage: "Replace reference image",
        removeReferenceImage: "Remove reference image",
        referenceImageURL: "Reference image URL {{index}}",
        localReferenceHint: "JPEG / PNG / WebP / GIF, up to 8 images, 12 MiB each. With references, image editing is used.",
        remoteReferenceHint: "Add one or more HTTPS image URLs. With references, image editing is used.",
        videoLocalReferenceHint: "JPEG / PNG / WebP / GIF, one first-frame image, 12 MiB max.",
        videoRemoteReferenceHint: "Provide one HTTPS image URL as the first-frame reference.",
        videoReferenceLocalHint: "JPEG / PNG / WebP / GIF, one reference image, 12 MiB max.",
        videoReferenceRemoteHint: "Provide one HTTPS image URL as a video reference image.",
        referencePreviewFailed: "Unable to preview this image URL (unreachable or blocked by CORS/hotlink rules)",
        openReferencePreview: "Open fullscreen reference preview",
